...
#ora Di solito creo file temporaneo che deve essere eliminato allla fine in cui salvo dati che possono essere nomi di file o specifiche 
#righe di file o possono essere anche numeri o altro.
